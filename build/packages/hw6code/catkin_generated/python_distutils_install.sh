...
echo_and_run cd "/home/robot/133ws/src/packages/hw6code"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/robot/133ws/src/packages/hw6code/setup.py" \
     \
    build --build-base "/home/robot/133ws/build/packages/hw6code" \
    install \
    --root="${DESTDIR-/}" \
