...
class Generator:
    ...
    def __init__(self):
        ...
        ##### CHANGE THESE #####
        pA = np.array([ -2.4669, 2.6334, -0.6435 ])
        pB = np.array([ -2.4669, 1.9899, 0.6435 ])
        pC = np.array([ 0.6747, 1.1517, -0.6435 ])
        pD = np.array([ 0.6747, 0.5082, 0.6435 ])
        

        self.segments = (Goto(pA, pB, 1.0),
                         Hold(pB, 0.5),
                         Goto(pB, pC, 1.0),
                         Hold(pC, 0.5),
                         Goto(pC, pD, 1.0),
